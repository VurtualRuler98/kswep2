...
if (CLIENT) then
	SWEP.PrintName = "TEST Jennings J-22"
	SWEP.Author = "vurtual"
	SWEP.Slot = 1
	SWEP.SlotPos = 0
end
...
SWEP.Spawnable = true
list.Add("NPCUsableWeapons", { class = "weapon_kswept_j22", title = "TEST Jennings J-22" } )
...
SWEP.Primary.Sound = Sound("Weapon_kswept_j22.Single")
SWEP.UseHands = true
