...
if (CLIENT) then
	SWEP.PrintName = "TEST FN Five-seven"
	SWEP.Author = "vurtual"
	SWEP.Slot = 1
	SWEP.SlotPos = 0
end
...
SWEP.Spawnable = true
list.Add("NPCUsableWeapons", { class = "weapon_kswept_fiveseven", title = "TEST FN Five-seven" } )
...
SWEP.Primary.Sound = Sound("Weapon_kswept_fiveseven.Single")
SWEP.UseHands = true
