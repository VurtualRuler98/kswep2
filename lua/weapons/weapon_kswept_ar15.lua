...
SWEP.Spawnable = true
list.Add("NPCUsableWeapons", { class = "weapon_kswept_ar15", title = "TEST AR-15" } )


--Barrel--
SWEP.HandlingModifier=5
SWEP.Length=32
SWEP.Primary.Spread = 0.01 --precision barrel
